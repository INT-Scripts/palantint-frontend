    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-zinc-950/90 backdrop-blur-md animate-in fade-in duration-300">
            <div className="bg-zinc-900/80 backdrop-blur-2xl border border-zinc-800 rounded-none w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden shadow-[0_0_50px_rgba(0,0,0,1)] relative animate-in zoom-in-95 duration-300">
                {/* Tech Accents */}
                <div className="absolute top-0 left-0 w-8 h-[2px] bg-student-500 shadow-[0_0_10px_rgba(59,130,246,0.8)]" />
                <div className="absolute top-0 left-0 w-[2px] h-8 bg-student-500 shadow-[0_0_10px_rgba(59,130,246,0.8)]" />
                <div className="absolute bottom-0 right-0 w-8 h-[2px] bg-student-500 shadow-[0_0_10px_rgba(59,130,246,0.8)]" />
                <div className="absolute bottom-0 right-0 w-[2px] h-8 bg-student-500 shadow-[0_0_10px_rgba(59,130,246,0.8)]" />

                <div className="flex justify-between items-center p-8 border-b border-zinc-800">
                    <div className="flex flex-col gap-1 min-w-0 flex-1">
                        <div className="flex items-center gap-3 text-student-500 mb-1">
                ...
                <div className="p-8 overflow-y-auto flex-1 custom-scrollbar">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center py-24 space-y-6">
                            <div className="w-12 h-12 border-4 border-student-500/20 border-t-student-500 animate-spin" />
                        ...
                        <div className="space-y-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="bg-black/40 border border-zinc-800/60 p-5 group hover:border-student-500/30 transition-all">
                                    <p className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest mb-3 flex items-center gap-2">
                                        <Clock className="w-3 h-3 text-student-500" /> Temporal Window
                                    </p>
                                ...
                                <div className="bg-black/40 border border-zinc-800/60 p-5 group hover:border-housing-500/30 transition-all">
                                    <p className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest mb-3 flex items-center gap-2">
                                        <MapPin className="w-3 h-3 text-housing-500" /> Geospatial Loc
                                    </p>
                                    <div className="space-y-1">
                                ...
                                {details.club_name && (
                                    <div className="bg-black/40 border border-zinc-800/60 p-5 group hover:border-orga-500/30 transition-all">
                                        <p className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest mb-3 flex items-center gap-2">
                                            <Users className="w-3 h-3 text-orga-500" /> Organizing Entity
                                        </p>
                                        <div className="flex items-center gap-3">
                                            <span 
                                                ...
                                                style={{ 
                                                    ...
                                                    color: details.club_color || PALETTE.orga[500],
                                ...
                                <div className="flex flex-col sm:flex-row justify-between sm:items-end gap-6 border-b border-zinc-800/60 pb-6">
                                    <div className="space-y-1">
                                        <h4 className="text-xl font-black text-white uppercase tracking-tighter flex items-center gap-3">
                                            <Users className="w-5 h-5 text-student-500" /> Manifest Attendees
                                        </h4>
                                    ...
                                    <div className="relative group/search">
                                        <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-600 group-focus-within/search:text-student-500 transition-colors" />
                                        <input
                                            type="text"
                                            placeholder="FILTER: SUBJECT NAME"
                                            value={searchQuery}
                                            onChange={(e) => setSearchQuery(e.target.value)}
                                            className="bg-zinc-950 border border-zinc-800 rounded-none px-10 py-2.5 text-[10px] font-mono text-white outline-none focus:border-student-500/50 w-full sm:w-60 transition-all"
                                        />
                                    </div>
                                </div>
                                    ...
                                    {attendees.map((student: any) => (
                                        ...
                                        >
                                            ...
                                            <div className="min-w-0">
                                                <p className="text-xs font-black text-white group-hover/s:text-student-400 transition-colors uppercase truncate">
                                            ...
                                            <div className="ml-auto opacity-0 group-hover/s:opacity-100 transition-opacity">
                                                <Activity className="w-3 h-3 text-student-500" />
                                            </div>
                                        </div>
                                    ))}
                                    {attendees.length === 0 && (
