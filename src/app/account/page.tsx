...
export default function AccountPage() {
    ...
    if (loading) {
        return (
            <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center font-mono space-y-4">
                <div className="w-12 h-12 border-2 border-blue-500/20 border-t-blue-500" />
    ...
    return (
        <div className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-blue-500/30 font-sans">
            ...
            <div className="fixed top-[-10%] left-[-5%] w-[40vw] h-[40vw] rounded-none bg-blue-600/5 blur-[150px] pointer-events-none mix-blend-screen z-0" />
            <div className="fixed bottom-[-10%] right-[-5%] w-[40vw] h-[40vw] rounded-none bg-purple-600/5 blur-[150px] pointer-events-none mix-blend-screen z-0" />
                            ...
                            <div className="p-8">
                                <div className="flex flex-col items-center text-center">
                                    <div className="relative mb-8 group/avatar">
                                        <div className="absolute -inset-4 bg-blue-500/5 rounded-full blur-3xl opacity-0 group-hover/avatar:opacity-100" />
                                        <div className="relative w-40 h-40 border border-zinc-800 p-1 bg-zinc-950/50 rounded-none">
                                            ...
                                            <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 border-blue-500/40 m-2 group-hover/avatar:border-blue-500" />
                                            <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 border-blue-500/40 m-2 group-hover/avatar:border-blue-500" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="font-mono text-[10px] text-blue-500 tracking-[0.4em] font-black uppercase">
                                    ...
                                    <div className="w-full space-y-4 text-left font-mono text-[10px]">
                                        ...
                                        <div className="flex justify-between items-center group/row">
                                            ...
                                            <span className="text-blue-500 font-bold">{student?.ecole || "EXTERNAL"}</span>
                                        </div>
                                        <div className="flex justify-between items-center group/row">
                                        ...
                                        <div className="flex justify-between items-center group/row">
                                            <span className="text-orange-500 uppercase tracking-widest group-hover/row:text-orange-400">Facility ID</span>
                                            <span className="text-orange-400 font-black">{student?.apartment || "UNASSIGNED"}</span>
                                        </div>
                                    </div>

                                    <div className="w-full mt-10 grid grid-cols-1 gap-3">
                                        <Link href={student ? `/students/${student.id}` : "#"} className="block w-full">
                                            <Button className="w-full bg-blue-600/10 hover:bg-blue-600/20 border border-blue-500/30 text-blue-400 font-mono uppercase tracking-[0.2em] font-black h-12 rounded-none">
                                                Student Profile
                                            </Button>
                                        </Link>
                                        {user?.is_admin && (
                                            <Link href="/admin" id="admin-console-link" className="block w-full">
                                                <Button className="w-full bg-red-600/10 hover:bg-red-600/20 border border-red-500/30 text-red-500 font-mono uppercase tracking-[0.2em] font-black h-12 rounded-none shadow-[0_0_20px_rgba(239,68,68,0.05)]">
                                                    Admin Console
                                                </Button>
                                            </Link>
                                        )}
                        ...
                        <section className="bg-zinc-900/40 backdrop-blur-3xl border border-zinc-800/60 p-6 rounded-none relative overflow-hidden shadow-xl">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="text-[10px] font-mono text-white uppercase tracking-widest flex items-center gap-2">
                                    <Key className="w-4 h-4 text-blue-500" /> Identity Link (CAS)
                                </h3>
                                <div className={`w-2 h-2 rounded-none ${casStatus?.has_credentials ? 'bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)]' : 'bg-red-500'}`} />
                            </div>
                            ...
                            {!showCasForm ? (
                                <div className="space-y-4">
                                    ...
                                    <Button 
                                        ...
                                        className="w-full h-10 bg-zinc-950 border border-zinc-800 text-blue-400 hover:text-white hover:bg-blue-900 rounded-none text-[10px] font-mono uppercase tracking-widest"
                                    >
                                ...
                                <form onSubmit={handleSaveCas} className="space-y-4">
                                    <div className="space-y-2">
                                        <input 
                                            ...
                                            className="w-full bg-zinc-950 border border-zinc-800 rounded-none px-4 py-3 text-xs font-mono text-white outline-none focus:border-blue-500/50"
                                        />
                                        <input 
                                    ...
                                    <div className="flex gap-2">
                                        <Button disabled={casSaving} className="flex-1 bg-blue-600 hover:bg-blue-500 text-[10px] font-mono uppercase tracking-widest rounded-none h-10 border-none">
                                            Commit
                                        </Button>
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center justify-between mb-10 border-b border-zinc-800 pb-6">
                                    <h3 className="font-mono text-xs font-black uppercase tracking-[0.3em] flex items-center gap-4 text-white">
                                        <Calendar className="w-5 h-5 text-blue-500" /> Mission Timeline
                                    </h3>
                                </div>
                                    ...
                                    <div className="space-y-4">
                                        {events.slice(0, 5).map((evt) => (
                                            <div 
                                                ...
                                                className="flex items-center gap-8 p-6 bg-black/40 border border-zinc-800/50 hover:border-blue-500/40 hover:bg-blue-500/[0.03] group/event cursor-pointer rounded-none"
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-lg font-black text-white uppercase truncate group-hover/event:text-blue-400 tracking-tight">{evt.name}</p>
                                                    <div className="inline-flex items-center gap-6 font-mono text-[10px] text-zinc-500 uppercase tracking-widest mt-1">
                                                        <span className="flex items-center gap-2"><Clock className="w-3 h-3 text-blue-500" /> {new Date(evt.start_time).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
                                                        <span className="flex items-center gap-2"><MapPin className="w-3 h-3 text-orange-500" /> {evt.room || "OFF_SITE"}</span>
                                                    </div>
                                                </div>
                                                <ChevronRight className="w-5 h-5 text-zinc-800 group-hover/event:text-blue-500" />
                                            </div>
                                        ))}
                                    </div>
                                ) : (
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        ...
                        <section className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/60 p-6 rounded-none shadow-xl">
                            <h3 className="text-[10px] font-mono text-zinc-500 uppercase tracking-[0.3em] font-black mb-6 flex items-center gap-3">
                                <Users className="w-4 h-4 text-emerald-500" /> Entity Links
                            </h3>
                            <div className="space-y-3">
                                {student?.clubs?.length > 0 ? (
                                    student.clubs.map((club: any) => (
                                        <Link key={club.id} href={`/clubs/${club.id}`} className="block border border-zinc-800 bg-black/20 hover:border-emerald-500/40 hover:bg-emerald-500/[0.03] group/club p-4 rounded-none">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div className="min-w-0 text-left">
                                                    <p className="text-[11px] font-black text-white uppercase truncate group-hover/club:text-emerald-400">{club.name}</p>
                        ...
                        <section className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/60 p-6 rounded-none shadow-xl">
                            <h3 className="text-[10px] font-mono text-zinc-500 uppercase tracking-[0.3em] font-black mb-6 flex items-center gap-3">
                                <Home className="w-4 h-4 text-orange-500" /> Neighborhood Protocol
                            </h3>
                            <div className="grid grid-cols-2 gap-3">
                                {neighbors.length > 0 ? (
                                    neighbors.map((n: any) => (
                                        <Link key={n.id} href={`/students/${n.id}`} className="group/n">
                                            <div className="relative border border-zinc-800 bg-black/40 p-3 hover:border-orange-500/30 text-center rounded-none">
                                                ...
                                                <p className="text-[8px] font-mono text-orange-500/60 uppercase">{n.apartment || "---"}</p>
                                            </div>
                                        </Link>
                                    ))
                                ) : (
