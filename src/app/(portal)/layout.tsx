...
export default function PortalLayout({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-100 via-stone-200/50 to-orange-100/30 dark:from-stone-950 dark:via-stone-900/90 dark:to-amber-950/10 text-stone-900 dark:text-stone-100 antialiased font-sans transition-colors duration-300 relative overflow-x-clip">
