...
import { ArrowRight, HardDrive, Compass, Home as HomeIcon, Map, Database, Cpu } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const lines = [
      ...
      tokenValid
        ...
        : "[INIT] TROMBINT       .............. [ ACCESS RESTRICTED ]",
      tokenValid
        ? "[INIT] SI-AGENDA      .............. [ AUTHORIZED ]"
        : "[INIT] SI-AGENDA      .............. [ ACCESS RESTRICTED ]",
    ...
    return (
      <div className="min-h-screen bg-zinc-950 text-white relative overflow-hidden font-sans selection:bg-zinc-800">
        ...
        <div className="absolute inset-0 pointer-events-none z-0 opacity-[0.06] bg-zinc-950">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id="bg-grid-guest" width="80" height="80" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#bg-grid-guest)" />
          </svg>
        </div>

        {/* Ambient Glows */}
        <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
          <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[50%] bg-emerald-900/5 blur-[180px] rounded-none mix-blend-screen" />
          <div className="absolute top-[40%] right-[-10%] w-[50%] h-[60%] bg-zinc-900/10 blur-[180px] rounded-none mix-blend-screen" />
          <div className="absolute bottom-[-10%] left-[20%] w-[45%] h-[50%] bg-amber-900/5 blur-[180px] rounded-none mix-blend-screen" />
        </div>

        <main className="relative z-10 w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 mt-4">
          
          {/* HERO */}
          <section className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto mb-24">
            <img 
              src="/palantint.svg" 
              alt="INT Portal Logo" 
              className="w-48 h-48 sm:w-56 sm:h-56 opacity-95 filter drop-shadow-[0_0_30px_rgba(240,147,20,0.15)] select-none pointer-events-none" 
            />

            <div className="space-y-6">
              <h1 className="text-6xl sm:text-8xl font-black tracking-tighter uppercase leading-none text-white select-none">
                INT<span className="text-zinc-500"> PORTAL</span>
              </h1>
              <p className="text-sm sm:text-base text-zinc-400 font-mono max-w-2xl mx-auto uppercase tracking-wide leading-relaxed">
                The official gateway for campus associations, interactive building floor plans, unified timetables, and campus layouts.
              </p>
            </div>
          ...
          <section className="space-y-12 mb-24">
            <div className="flex items-center gap-6">
              <h2 className="text-2xl font-black uppercase tracking-tight flex items-center gap-3 text-white">
                <HardDrive className="w-5 h-5 text-zinc-500" /> Campus Resources
              </h2>
                ...
                <CardContent className="p-8 space-y-6 flex flex-col h-full justify-between">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      {/* Node cluster vector preview */}
                      <svg className="w-10 h-10 text-zinc-700 group-hover:text-emerald-400 transition-colors" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1">
                  ...
                  <div className="pt-6 flex justify-end items-center text-[10px] font-mono tracking-widest uppercase border-t border-zinc-800/60 mt-8 group-hover:border-emerald-500/20 transition-colors">
                    <span className="text-emerald-400 flex items-center gap-2 group-hover:translate-x-1 transition-transform font-bold">
                ...
                <CardContent className="p-8 space-y-6 flex flex-col h-full justify-between">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      {/* Isometric room blueprint preview */}
                      <svg className="w-10 h-10 text-zinc-700 group-hover:text-amber-400 transition-colors" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1">
                  ...
                  <div className="pt-6 flex justify-end items-center text-[10px] font-mono tracking-widest uppercase border-t border-zinc-800/60 mt-8 group-hover:border-amber-500/20 transition-colors">
                    <span className="text-amber-400 flex items-center gap-2 group-hover:translate-x-1 transition-transform font-bold">
                      VIEW METADATA <ArrowRight className="w-3.5 h-3.5" />
                    </span>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-8 space-y-6 flex flex-col h-full justify-between">
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      {/* Rotating skeletal cube vector */}
                      <svg className="w-10 h-10 text-zinc-700 group-hover:text-zinc-400 transition-colors animate-[spin_12s_linear_infinite]" viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="1">
                        <rect x="25" y="25" width="45" height="45" />
                        <rect x="35" y="35" width="45" height="45" strokeDasharray="2 2" />
                        <line x1="25" y1="25" x2="35" y2="35" />
                        <line x1="70" y1="25" x2="80" y2="35" />
                        <line x1="25" y1="70" x2="35" y2="80" />
                        <line x1="70" y1="70" x2="80" y2="80" />
                      </svg>
                    </div>
                    <h3 className="text-2xl font-black text-white uppercase tracking-wide group-hover:text-zinc-350 transition-colors">
                      Campus 3D Wireframe
                    </h3>
                    <p className="text-zinc-400 text-xs font-mono uppercase tracking-tight leading-relaxed">
                      Interactive physical mapping powered by WebGL. Visualise three-dimensional structural outlines and campus structures.
                    </p>
                  </div>
                  <div className="pt-6 flex justify-end items-center text-[10px] font-mono tracking-widest uppercase border-t border-zinc-800/60 mt-8 group-hover:border-zinc-400/20 transition-colors">
                    <span className="text-zinc-300 flex items-center gap-2 group-hover:translate-x-1 transition-transform font-bold">
    ...
    <div className="min-h-screen bg-zinc-950 text-white relative overflow-hidden font-sans selection:bg-zinc-800">
      ...
      <main className="relative z-10 w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 mt-4">
        ...
        <section className="space-y-12 mb-24">
          <div className="flex items-center gap-6">
            <h2 className="text-2xl font-black uppercase tracking-tight flex items-center gap-3 text-white">
              <HardDrive className="w-5 h-5 text-zinc-500" /> Platform Infrastructure
            </h2>
            <div className="h-px flex-1 bg-gradient-to-r from-zinc-800 to-transparent" />
          </div>
