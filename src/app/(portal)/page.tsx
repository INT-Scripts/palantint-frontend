...
import { Building2, Users, WashingMachine } from "lucide-react";
...
export default function PortalHomePage() {
  return (
    <section className="flex-1 max-w-6xl mx-auto w-full px-4 py-20 sm:py-28 flex flex-col justify-center relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-y-12 md:gap-y-0 divide-y md:divide-y-0 md:divide-x divide-zinc-200/60 dark:divide-stone-800/30 border border-zinc-200/80 dark:border-stone-800/50 bg-stone-50/90 dark:bg-stone-900/90 backdrop-blur-sm rounded-2xl p-8 sm:p-12 shadow-sm relative z-10">
        
        {/* Clubs Column */}
        <Link href="/clubs" className="group flex flex-col justify-between h-full md:pr-8 md:pl-0 pt-6 md:pt-0">
          <div>
        ...
        {/* Housing Column */}
        <Link href="/apartments" className="group flex flex-col justify-between h-full md:px-8 pt-6 md:pt-0">
          <div>
        ...
        {/* Laundry Column */}
        <Link href="/laundry" className="group flex flex-col justify-between h-full md:pl-8 md:pr-0 pt-6 md:pt-0">
          <div>
